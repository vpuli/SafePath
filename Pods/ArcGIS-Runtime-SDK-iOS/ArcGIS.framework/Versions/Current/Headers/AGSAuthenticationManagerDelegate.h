...
#if TARGET_OS_IPHONE && !TARGET_OS_TV
/** Tells the delegate that the `AGSAuthenticationManager` wants to show the provided view controller as part of handling the authentication challenge using its own default handler. It then becomes the delegate's responsibility to present the view controller.
...
/** Tells the delegate that the `AGSAuthenticationManager` wants to dismiss the provided view controller as part of handling the authentication challenge using its own default handler. It then becomes the delegate's responsibility to dismiss the view controller.
