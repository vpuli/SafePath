...
/** Initialize a stretch renderer.
 ...
 @param estimateStats indicating whether statistics should be estimated for raster datasets that don't contain statistical information about their pixel values
