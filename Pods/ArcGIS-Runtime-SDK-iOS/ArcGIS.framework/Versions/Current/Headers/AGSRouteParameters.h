...
/**  Input parameters for `AGSRouteTask`
 ...
 @note Consider using the convenience method [`AGSRouteTask generateDefaultParametersWithCompletion:`] to get an instance of this class that is initialized with smart default values based on the task's metadata [(`AGSRouteTask routeTaskInfo`)]
 
 @since 100
 */
@interface AGSRouteParameters : AGSObject
...
/** A list of network attributes to be accumulated and returned as part of the route.
 Available attributes are specified by [`AGSRouteTaskInfo accumulateAttributeNames`.]
 @since 100
 */
