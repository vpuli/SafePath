...
/** Determines whether to filter features based on geometry to include in the geodatabase. Only features that intersect [`AGSGenerateGeodatabaseParameters extent`] are considered for inclusion.
 @since 100
 */
