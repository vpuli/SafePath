...
/**  Parameters to generate a sync-enabled geodatabase
 ...
 Instances of this class represent parameters that are used with [`AGSGeodatabaseSyncTask generateJobWithParameters:downloadPath:`] to generate sync-enabled geodatabases from supporting ArcGIS Feature services.
