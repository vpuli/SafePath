...
/** Shows the callout at the specified location for the provided feature.
 The callout's  delegate, if it exists, is informed just before the callout is shown through
  [AGSCalloutDelegate callout:willShowAtMapPoint:]
...
/**  A delegate of  AGSCallout.
 ...
 interacts with the callout. An instance of the class must be set as  [AGSCallout delegate.]
