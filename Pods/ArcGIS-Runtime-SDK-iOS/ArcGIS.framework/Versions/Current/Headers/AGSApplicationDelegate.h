...
/** Provides a way to process  NSURLSession related events for data downloaded in the background.
 The download could have been initiated in the background by  application:performFetchWithCompletionHandler:, or it might have been initiated in the
 ...
 Once the download finishes, the completion handler on your  AGSGDBSyncTask or  AGSExportTileCacheTask will be invoked to let you know that the job has
...
/** Provides a way to process the result returned from Safari/SFSafariViewController if you are using Safari-based, out-of-app authentication workflow.
 ...
 @since 100
 */
-(BOOL)application:(UIApplication*)application openURL:(NSURL*)url sourceApplication:(nullable NSString*)sourceApplication annotation:(nullable id)annotation;
