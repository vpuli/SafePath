...
/** @mainpage Introduction
 ...
 You need to use a minimum of iOS 10 SDK to build your applications. Also, the applications you build will require a minimum of iOS 9 running on the device.
 ...
 - Add <b>pod 'ArcGIS-Runtime-SDK-iOS', '100.0'</b> to your Podfile.
 ...
 You need to use a minimum of macOS 10.12 SDK to build your applications. Also, the applications you build will require a Mac running a minimum of macOS El Capitan (10.11).
 
 @section sec1 Setting up your XCode project using CocoaPods
 
 If you're already using <a target="_blank" href="http://cocoapods.org/">CocoaPods</a>, setting up your project to use ArcGIS is really easy.
 
 - Add <b>pod 'ArcGIS-Runtime-SDK-macOS', '100.0'</b> to your Podfile.
 - Run the command <b>pod install</b> on the Podfile using the Terminal application.
 - Open the project workspace (*.xcworkspace file) and add the [<b> import] &lt;ArcGIS/ArcGIS.h&gt;</b>  statement to any class files where you wish to use the API.
...
/**  @defgroup beta
  Features that are currently in beta and not suitable for production deployment.
 
 This page lists all the features that are currently in beta and not suitable for production deployment. The API, behavior, and functionality is subject to change in future releases.
 */
