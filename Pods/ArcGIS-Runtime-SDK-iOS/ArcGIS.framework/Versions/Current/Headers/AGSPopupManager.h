...
/** Notification that is fired when the validity of a feature changes.
 @since 100
 */
AGS_EXTERN NSString * _Nonnull const AGSPopupManagerGeoElementValidityDidChangeNotification;

/** Notification that is fired when the feature type for a feature in a popup changes.
 @since 100
 */
AGS_EXTERN NSString * _Nonnull const AGSPopupManagerFeatureTypeDidChangeNotification;
...
/** A delegate of the popup manager that is notified about changes in the popup state or validity.
 @since 100
 */
@property (nonatomic, weak, readwrite) id<AGSPopupManagerDelegate> delegate;
...
/**
 ...
 @since 100
 */
-(nullable NSString*)stringForTemplatedString:(NSString*)string;

/**
 Creates correct number type from a string. Uses the AGSPopupField to determine type of number to return (int, double, etc)
 @since 100
 */
-(nullable NSNumber*)numberFromString:(NSString*)stringValue field:(AGSPopupField*)popupField;
...
/**
 ...
 @since 100
 */
-(id)valueForField:(AGSPopupField*)popupField;
...
/** Finish editing the popup.
 ...
 @since 100
 */
-(void)finishEditingWithCompletion:(void(^)(NSError *error))completion;
...
/** Update the value of a field in the AGSGeoElement associated with the popup.
 Returns  YES if the new value passes validation.
 @since 100
 */
-(BOOL)updateValue:(nullable id)newValue field:(AGSPopupField*)popupField validationError:(NSError**)error;
...
/** Update the feature type of the AGSGeoElement associated with the popup.
 ...
 @since 100
 */
-(BOOL)updateFeatureTypeWithTemplate:(nullable AGSFeatureTemplate*)featureTemplate changeMode:(AGSPopupFeatureTypeChangeMode)changeMode validationError:(NSError**)error;
