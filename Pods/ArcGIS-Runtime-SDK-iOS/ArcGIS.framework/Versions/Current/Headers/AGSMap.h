...
/** Saves this map as a new web map on the specified portal with the given title in the given folder.
 ...
 @param forceSaveToSupportedVersion Flag to indicate whether the map should be saved to the supported webmap version that the API supports (see system requirements). This may cause data loss as unknown data is not saved. If  YES, unknown data will be removed and the map
 will be saved. If  NO, the operation will fail if the map contains unknown data that will not be saved. This flag can be used to provide a warning to users that some map data may be lost when the map is saved.
...
/** Saves this map back to the item it originated from.  Upon completion, the item's data will have been updated with the map.
 ...
 or has been previously saved as a new item using [` saveAs:portal:tags:folder:itemDescription:thumbnail:completion:`] or [` saveAs:completion:`.]
