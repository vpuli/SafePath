...
/**  Result of queries that return features.
 ...
 The  AGSFeatureEnumerator class conforms to `%NSFastEnumeration` which permits the collection to be enumerated conveniently using a for-in loop. For example -
