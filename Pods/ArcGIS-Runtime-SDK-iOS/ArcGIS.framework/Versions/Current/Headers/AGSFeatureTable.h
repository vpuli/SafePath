...
/**  A source for dataset containing geographic features or non-spatial records
 ...
 @since 100
 */
@interface AGSFeatureTable : AGSLoadableBase
...
/** Delete the specified feature in the dataset.
 ...
 @ingroup licensing
 @since 100
 @see  canDeleteFeature: to check if a particular feature can be deleted based on the source's ownership-based access control policies
 */
...
/**
 ...
 @since 100
 */
-(id<AGSCancelable>)queryFeaturesWithParameters:(AGSQueryParameters *)parameters completion:(nullable void(^)(AGSFeatureQueryResult *__nullable result, NSError *__nullable error))completion;
...
/** Update the specified feature in the dataset.
 ...
 @ingroup licensing
 @since 100
 @see  canUpdateFeature: to check if a particular feature can be updated based on the source's ownership-based access control policies
 */
