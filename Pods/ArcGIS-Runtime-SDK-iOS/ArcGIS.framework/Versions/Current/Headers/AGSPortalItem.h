...
/**  Object representing a unit of content in an ArcGIS portal.
 ...
 textual data which has to be fetched explicitly using  [` fetchDataWithCompletion:`.]  For example, an item of type  AGSPortalItemTypeMapPackage will
...
/** Information about licenses or restrictions to view or edit the item. 
 @since 100
 */
@property (nonatomic, copy, readwrite) NSString *accessAndUseConstraintsHtml;
...
/** Kicks off an operation to update the portal item's properties on the portal. The completion block is invoked when the operation completes successfully or if an error is encountered.
 @param completion block that is invoked when operation finishes
 @return operation which can be canceled
 @license{Basic}
 @ingroup licensing
...
/** Kicks off an operation to update the file for the item on the portal. The completion block is invoked when the operation completes successfully or if an error is encountered. This method is applicable for portal items that represent a static file, such as a shapefile, CSV, etc.
 @param fileData The binary data with which to update the portal item.
 @param completion block that is invoked when operation finishes
 @return operation which can be canceled
 @license{Basic}
 @ingroup licensing
