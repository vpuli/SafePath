...
/** The delegate to be notified when a user interacts with the popups or
 ...
 must adopt the  AGSPopupsViewControllerDelegate protocol.
 @since 100
 */
...
/** When in edit mode and geometry editing is allowed, this property
 returns the sketchEditor for editing the popup's geometry. This is the sketchEditor you passed to the  AGSPopupsViewController in the  popupsViewController:sketchEditorForPopup: delegate method.
...
/**
 ...
 @param popups An array of  AGSPopup objects representing the additional popups to be displayed
 @since 100
 */
...
/** Initializes an AGSPopupsViewController.
 @param popups An array of AGSPopup objects representing the popups to be displayed
 @param containerStyle specifies how the popups view controller will be displayed in its container.  See  AGSPopupsViewControllerContainerStyle
 @since 100
 */
