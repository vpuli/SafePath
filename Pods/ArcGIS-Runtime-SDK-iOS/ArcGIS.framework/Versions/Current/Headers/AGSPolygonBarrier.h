 ...
 */
@interface AGSPolygonBarrier : AGSObject
...
/** Initialize the polygon barrier with provided geometry
 @param polygon defining the shape and location of the barrier
 @return Initialized polygon barrier
 @since 100
 */
...
/**
 ...
 @since 100
 */
@property (nullable, nonatomic, strong, readwrite) AGSPolygon *geometry;
