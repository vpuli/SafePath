...
/**  Displays device location on a map
 ...
 The location display does not proactively retrieve any location information. That is the job of its [` dataSource`] which provides location updates on a frequent basis. The default dataSource uses the platform's location service (`CLLocationManager`).
 ...
 @see 
 @note The location display needs access to the device location manager in order to access the device's location. The app's Info.plist must contain an `NSLocationWhenInUseUsageDescription` or `NSLocationAlwaysUsageDescription` key to permit this functionality.
 @since 100
 */
...
/** The source for location updates.
 Defaults to  AGSCLLocationDataSource.
...
/** Most recent location update provided by the [` dataSource`.]
 ...
 @since 100
 */
@property (nullable, nonatomic, copy, readonly) AGSLocation *location;
