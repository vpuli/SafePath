...
/** Specifies whether the symbol should rotate with the map or stay at the same angle with regards to the screen. Default is `AGSMarkerSymbolAngleAlignmentMap`.
 Only supported for `AGSGraphicsOverlay` using  AGSGraphicsRenderingModeDynamic
 @since 100
 */
