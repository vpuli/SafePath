...
/**  A job to export a tile cache from an ArcGIS Tile service.
 ...
 Instances of this class represent a long running job on a remote server that can export a tile cache from an ArcGIS Tile service.
 ...
 @since 100
 */
@interface AGSExportTileCacheJob : AGSJob
...
/** Result of the job.
 @since 100
 */
@property (nullable, nonatomic, strong, readonly) AGSTileCache *result;
...
-(void)startWithStatusHandler:(nullable void(^)(AGSJobStatus status))statusHandler
                   completion:(void(^)(AGSTileCache * __nullable result, NSError * __nullable error))completion;
